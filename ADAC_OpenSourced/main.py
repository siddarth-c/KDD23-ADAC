...
# https://www.eclipse.org/lists/sumo-user/msg09917.html
...
def main():
    ...
    ap.add_argument("--pwd", type=str, default = '/home/Name//Name/RESCO_ADAC/RESCO_main/resco_benchmark')
    ap.add_argument("--log_dir", type=str, default=os.path.join('/home/Name//Name/RESCO_ADAC/RESCO_main/resco_benchmark', 'results' + os.sep))
